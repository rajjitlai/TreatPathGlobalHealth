    ...
    <div className="container mx-auto px-8 lg:px-16 pt-16">
      <div className="text-center mb-12">
        ...
        <p className="text-gray-600 dark:text-gray-400 text-lg max-w-2xl mx-auto">
          Discover our curated collection of women's health and wellness products
        </p>
        {totalProducts > 0 && (
            ...
            {products.length > 0 ? (
              ...
              <div className="col-span-full text-center py-20">
                <div className="bg-gray-100 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-2xl p-8 max-w-md mx-auto">
                  <p className="text-gray-500 dark:text-gray-400 font-medium">No women's products found.</p>
                </div>
              </div>
            )}
          </div>
